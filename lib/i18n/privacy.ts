...
const pt: PrivacyPolicyCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        "Nome ou apelido escolhido, iniciais e cor visual do jogador.",
        ...
        "Preferências guardadas no dispositivo, como idioma, sons e último aviso de instalação.",
...
const en: PrivacyPolicyCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        "Your chosen name or nickname, initials and player colour.",
        ...
        "Preferences stored on your device, such as language, sounds and the latest installation prompt.",
...
const fr: PrivacyPolicyCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        "Nom ou pseudonyme choisi, initiales et couleur du joueur.",
        ...
        "Préférences enregistrées sur l'appareil, comme la langue, les sons et la dernière invite d'installation.",
